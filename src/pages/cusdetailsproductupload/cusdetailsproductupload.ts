...
/**
 * Generated class for the CusdetailsproductuploadPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-cusdetailsproductupload',
  templateUrl: 'cusdetailsproductupload.html',
})
export class CusdetailsproductuploadPage {
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad CusdetailsproductuploadPage');
  ...
  packageLists(){
    ...
    this.authService.postData(serval,'listuserSubscriptions').then((result) => {
...
submit(formData) {
  ...
  this.authService.productuploapayment(formData).subscribe(res => {
   if (res.Ack == 1) {
